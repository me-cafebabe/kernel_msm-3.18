...
#define LCD_WIDTH               (480)   //modify : �ֱ��ʣ�������Ŀʵ������޸ġ�
#define LCD_HEIGHT              (854)   //modify : �ֱ��ʣ�������Ŀʵ������޸ġ�
...
static int tpd_key_array[MAX_KEY_NUM] = {0};//{ KEY_APPSELECT, KEY_BACK,KEY_HOMEPAGE,KEY_SEARCH};//modify : ������Ŀʵ������޸�
...
static u16 _msg_GetVersion_MoreTime(void)
{
    ...
    for(version_check_time=0;version_check_time<5;version_check_time++)
    {
        ...
        if(TP_OF_XXX1==curr_ic_major
           ...
           ||TP_OF_XXX3==curr_ic_major)//modify :��ǰ��Ŀʹ�ø���tp�������汾�ţ����������Ŀʵ����������޸�
        {
            break;
        }
...
static void _msg_init_input(void)//modify :������ϵͳ��������Ŀ�޸�
{
	int err;
	int i;
...
static void _msg_set_rst_high(void)//modify: reset������, ������Ŀ�޸�
{
     gpio_set_value(this_data->pdata->reset_gpio, 1);
}

static void _msg_set_rst_low(void)//modify: reset������, ������Ŀ�޸�
{
...
static void _msg_disable_irq(void)//modify: �ж�disable����, ������Ŀ�޸�
{
	disable_irq_nosync(tpd_i2c_client->irq);
}
static void _msg_enable_irq(void)//modify: �ж�enable����, ������Ŀ�޸�
{
...
static void _msg_register_device_and_driver(void)//modify :������Ŀʵ�����ע���豸������
{
	i2c_add_driver(&tpd_i2c_driver);
}
static void _msg_del_device_and_driver(void)//modify :������Ŀʵ�����ж���豸������
{
